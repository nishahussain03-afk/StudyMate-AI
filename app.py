...
st.markdown(
    '<div class="subtitle">Your Intelligent Student Assistant</div>',
    unsafe_allow_html=True
)
...
user_input = st.chat_input("Ask StudyMate AI anything...")
...
if user_input:
    ...
    prompt = f"""
You are StudyMate AI, a helpful and friendly student assistant.
...
st.caption(
    "StudyMate AI | Built with Python, Streamlit, Hugging Face Transformers and PyTorch"
)